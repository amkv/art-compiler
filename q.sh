...
then
	...
	echo -e $WHT"q.sh$CLN arg1 arg2 arg3 arg4 arg5" "\t\tfor arguments"
...
# IF compiled, IF No arguments, IF 0 to 5 arguments, IF preset argument value
if [ -a $NAME ]
then
	...
	then
		...
		LOG "running ${NAME} with preset argument"
		./$NAME "$ARG" | tee -a $LOGS
	fi
else
	LOG "error compiling"
